...
const icDefinition: ICommandDefinition = {
    name: "ic",
    summary: "Diagnose all objects of the database for \"Imagecopy [action]\" [objects]",
    description: "[actions] in Zowe CLI are groups of commands. [actions] are always verbs. " +
        "For example, for command \"zowe dbi ds ic\", the [action] is \"ic\".\n\n" +
        "For this action (\"ic\") diagonsis of all or selected db2 objects in a database for imagecopy takes place.",
    type: "group",
